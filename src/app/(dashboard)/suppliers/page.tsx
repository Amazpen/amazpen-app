...
import { SuppliersHelpButton } from "@/components/onboarding/SuppliersHelpButton";
...
export default function SuppliersPage() {
  ...
  const fetchMonthlyData = useCallback(async (supplier: SupplierWithBalance, monthDate: Date) => {
    ...
    // actual payment was recorded. This matches the user's mental model of
    // "this month's invoices are settled" and stays in sync with total_paid
    // automatically — the sum of paid-status invoices for a supplier equals
    // the sum of payments to that supplier (verified for גד פרגו and the
    // other consolidated suppliers).
    //
    // This avoids the two failure modes we hit earlier:
    //  - allocation-based (status=paid top-up + payment_invoice_links) double-
  ...
  return (
    <div dir="rtl" className="flex flex-col min-h-[calc(100vh-52px)] text-white px-[5px] py-[5px] pb-[80px] gap-[10px]">
      ...
      <div className="flex-1 flex flex-col bg-[#0F1535] rounded-[10px]">
        ...
        <div id="onboarding-suppliers-search" className="flex items-center gap-[10px] mb-[10px]">
          <Button
            type="button"
            title="חיפוש"
            onClick={() => {
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="bg-[#29318A]/30 rounded-[10px] p-[15px] mb-[15px]">
              ...
              {/* Fixed-expense extras — only when marked as fixed */}
              {selectedSupplier.is_fixed_expense && (
                <div className="grid grid-cols-3 gap-[10px] mt-[15px]">
                  ...
                  <div /> {/* spacer to keep 3-column alignment consistent with other rows */}
                </div>
              )}
                            ...
                            <div className="flex flex-col gap-[10px] p-[5px] mt-[10px]">
                              <div className="border border-white/50 rounded-[7px] p-[3px] flex flex-col gap-[15px]">
                                ...
                                <div className="flex items-center justify-between px-[7px] flex-wrap gap-y-[8px]">
                                  ...
                                  <div className="flex flex-col items-center min-w-[60px]">
                                    <span className="text-[13px] text-[#979797]">סכום</span>
