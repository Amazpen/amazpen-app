...
export const ocrBusinessSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description:
        "כאן אפשר לגשת בכל עת לכל המסמכים שכבר נסרקו ונקלטו, לחפש חשבונית ישנה, ולצפות בתמונה המקורית שלה. כך תמיד יש לך גיבוי מסודר של כל המסמכים, גם הרבה אחרי שקלטת אותם.",
      side: "bottom",
      align: "end",
    },
  },
