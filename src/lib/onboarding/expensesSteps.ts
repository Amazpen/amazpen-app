...
const ADD_EXPENSE_DESCRIPTION = `<div>בלחיצה כאן נפתח טופס להזנת הוצאה חדשה לקטגוריה שנבחרה. מזינים את הספק, מספר החשבונית, הסכום (לפני ואחרי מע"מ), התאריך ואמצעי התשלום. כל הוצאה שמוזנת מצטרפת מיד לסיכומים, לגרף ולרשימה, ומשפיעה על חישוב הרווחיות ועל המעקב מול הספקים.</div>
<div style="margin-top:10px;border:1px solid rgba(255,255,255,0.25);border-radius:8px;padding:9px 11px;background:rgba(255,164,18,0.12);">
  <div style="font-size:12px;font-weight:700;color:#ffd17a;margin-bottom:3px;">קיצור דרך חכם: סריקת חשבונית (OCR)</div>
  <div style="font-size:12px;line-height:1.55;color:rgba(255,255,255,0.85);">במקום למלא ידנית, אפשר פשוט לצלם או להעלות תמונה או PDF של החשבונית. המערכת תקרא את המסמך אוטומטית ותמלא עבורך את הספק, הסכום, התאריך ואת פירוט הפריטים. כל שנותר הוא לאשר. זה חוסך זמן רב ומונע טעויות הקלדה.</div>
</div>
<div style="margin-top:10px;">כך נראה הטופס בפועל:</div>${EXPENSE_FORM_DEMO}`;
...
export const expensesSteps: DriveStep[] = [
  ...
  {
    element: "#onboarding-expenses-chart",
    popover: {
      title: "גרף ההוצאות",
      description:
        "גרף העוגה מציג את התפלגות ההוצאות לפי קטגוריות, לצד הסכום הכולל ואחוז ההוצאה מתוך הפדיון לתקופה שנבחרה. כך אפשר לזהות במבט אחד אילו קטגוריות צורכות את החלק הגדול ביותר מההוצאות, ולהבין מיד היכן מתרכז עיקר ההוצאה של העסק.",
      side: "bottom",
      align: "center",
    },
  },
  {
    element: "#onboarding-expenses-breakdown",
    popover: {
      title: "פירוט ההוצאות לפי קטגוריה",
      description:
        "מתחת לגרף מופיע פירוט מספרי של כל קטגוריית הוצאה: שם הקטגוריה, הסכום שהוצא בה והאחוז שלה מתוך הפדיון. האחוז מהפדיון הוא מדד חשוב לרווחיות, כי הוא מראה כמה מכל שקל הכנסה הולך לאותה קטגוריה. לחיצה על קטגוריה פותחת את פירוט הספקים שבתוכה, וכפתור 'לפירוט המלא' מציג את כל הקטגוריות.",
      side: "top",
      align: "center",
    },
  },
  {
    element: "#onboarding-expenses-recent",
    popover: {
      title: "חשבוניות אחרונות ופעולות נוספות",
      description:
        "מתחת לגרף מופיעות כל החשבוניות שהוזנו בתקופה הנבחרת, וכאן מתבצעות הפעולות היומיומיות על ההוצאות. אפשר לסנן את הרשימה לפי תאריך, ספק, מספר תעודה, סכום, כרטיס אשראי או הערות, וכך לאתר חשבונית מסוימת במהירות. כפתור ההורדה מייצא את הרשימה המוצגת לקובץ Excel לצורך הנהלת חשבונות או גיבוי.",
      side: "top",
      align: "center",
    },
  },
  {
    ...
    popover: {
      title: "טבלת ההוצאות",
      description:
        "כל שורה בטבלה היא חשבונית או הוצאה, עם התאריך, הספק, האסמכתא, הסכום וסטטוס התשלום. אפשר למיין לפי כל עמודה בלחיצה על הכותרת, ללחוץ על שורה כדי לראות את כל הפרטים, ולערוך או למחוק הוצאה לפי הצורך. זוהי התמונה המפורטת שמאחורי המספרים והגרף, והמקום לעדכן ולתחזק את הנתונים.",
      side: "top",
      align: "center",
    },
  },
