...
export const expensesSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      title: "גרף וסיכום ההוצאות",
      description:
        "האזור הזה מציג את ההוצאות בצורה ויזואלית: גרף עוגה שמפרק את ההוצאות לפי קטגוריות, לצד הסכום הכולל לתקופה שנבחרה. כך אפשר לזהות במבט אחד אילו קטגוריות צורכות את החלק הגדול ביותר מההוצאות, ולהבין מיד היכן מתרכז עיקר ההוצאה של העסק.",
      side: "top",
      align: "center",
    },
  },
