...
interface DocumentQueueProps {
  ...
  /**
   * Direct reassignment from the per-card business-name dropdown. Assignment
   * source-of-truth lives on the card itself (or the form's top picker, which
...
function DocumentCard({ document, isSelected, onClick, businessName, serial, businesses, onReassignBusiness }: DocumentCardProps) {
...
function DocumentCardVertical({ document, isSelected, onClick, businessName, serial, businesses, onReassignBusiness }: DocumentCardProps) {
